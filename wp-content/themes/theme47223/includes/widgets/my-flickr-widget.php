...
class MY_FlickrWidget extends WP_Widget {
	...
	<ul id="flickr" class="flickr_list unstyled clearfix"></ul>
	...
	<script>
		jQuery('#flickr').jflickrfeed({
			...
			itemTemplate: '<li class="flickr_li"><a class="thumbnail" rel="prettyPhoto[gallery-<?php echo $suf; ?>]" href="{{image_b}}" title="{{title}}"><div class="wrapper"><img class="flickr_img" src="{{image_s}}" alt="{{title}}" /><span class="zoom-icon"></span></div></a></li>'
		}, function(data) {
